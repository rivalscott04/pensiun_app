...
<main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <!-- Distribusi Status Kepegawaian (Simulasi dari Golongan) -->
        <div class="bg-white rounded-lg shadow-md p-6 border border-gray-200 col-span-1 lg:col-span-2">
        ...
        <!-- Distribusi Unit Kerja Terbanyak -->
        <div class="bg-white rounded-lg shadow-md p-6 border border-gray-200 col-span-1 lg:col-span-2">
